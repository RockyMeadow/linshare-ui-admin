    ...
    <a-col :xl="{span: 9, offset: 2}">
      <a-form :model="form" @submit="updateUser()">
        ...
        <div class="input-container" v-if="user.accountType === 'GUEST'">
          ...
          <a-date-picker style="width: 100%" v-model:value="form.expirationDate"/>
        </div>
        <div class="input-container">
    ...
    <a-col :xl="{span: 9, offset: 2}">
      <div class="info-block-container">
        ...
        <div class="info-block" v-if="user.accountType === 'GUEST'">
          ...
          <div class="info-block__value">{{ $d(user.expirationDate, 'mediumDateTime') }}</div>
        </div>
        <div class="info-block" v-if="user.accountType === 'GUEST'">
...
export default defineComponent({
  ...
  async setup () {
    ...
    const form = reactive({
      ...
      expirationDate: moment(user.value.expirationDate)
    });
